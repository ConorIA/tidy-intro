...
3. Find a .csv file on your own computer and read that into a dataframe. If you don't have one, find a spreadsheet (or make one), save it as a .csv, and read that in. You might like to use `file.choose` to find it.
